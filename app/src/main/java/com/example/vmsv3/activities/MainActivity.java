...
public class MainActivity extends AppCompatActivity {
    ...
    public void logout(View view) {
        // Tutaj obsługujemy kliknięcie przycisku "Wyloguj"
        // Możesz dodać dodatkową logikę wylogowania, jeśli to konieczne.

        // Przekieruj użytkownika z powrotem do ekranu logowania (LoginActivity).
